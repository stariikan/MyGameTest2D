...
public class SummonSlime : MonoBehaviour
{
    ...
    public void SummonGuards()
    {
        ...
        guard1.tag = "Summon";
        guard1.GetComponent<Enemy_Behavior>().GetNameOfObject(masterName);
        ...
        guard2.tag = "Summon";
        guard2.GetComponent<Enemy_Behavior>().GetNameOfObject(masterName);
        ...
        guard3.tag = "Summon";
        guard3.GetComponent<Enemy_Behavior>().GetNameOfObject(masterName);
    }
    ...
    public void MasterOfSummon(GameObject master)
    {
        masterName = master;
    }
