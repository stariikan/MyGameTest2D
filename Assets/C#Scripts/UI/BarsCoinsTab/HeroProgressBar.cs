...
public class HeroProgressBar : MonoBehaviour
{
    ...
    public void UpdateHPProgressBar()
    {
        ...
        {
            progressBar.fillAmount = currentProgress / maxProgress; //уменьшаем погрессбар (не забываем в юнити выставить настройки у изображени¤ fillAmount (пример 90 хп/100 хп =0,9 полоска уменьшитьс¤ на 10%
        }
    }
