    ...
    public void Attack()
    {
       ...
       if(playerDirecction > 0)
       ...
       else if (playerDirecction < 0)
        {
            ...
            Debug.Log("left" + firePointLeft.position);//ѕри каждой атаки мы будем мен€ть положени€ снар€да и задавать ей положение огневой точки получить компонент из снар€да и отправить его в направление в котором находитьс€ игрок
